...
## Analysis results
dir.create("Results")
dir.create("Results/Phytoplankton")

### Taxonomy statistics
dir.create("Results/Phytoplankton/01.ASV.tax")

bac3 <- bac3[,-1]
source("Functions/tax.stat.R")
result <- tax.stat(data[,c(group$variable,"taxonomy")],bac3)    
write.table(result[[1]],
            "Results/Phytoplankton/01.ASV.tax/Tax.stat.txt",
            row.names = FALSE,sep = "\t")
pdf("Results/Phytoplankton/01.ASV.tax/Tax.anno.per.pdf",width = 4,height = 4)
result[[2]]
dev.off()

### Alpha diversity analysis
dir.create("Results/Phytoplankton/02.Alpha")

### Alpha diversity indices calculation
dir.create("Results/Phytoplankton/02.Alpha/01.Estimators")
source("Functions/alpha_diversity_indices.R")
otu_Flattening = as.data.frame(rrarefy(bac1, min(rowSums(bac1))))
bac1 <- otu_Flattening
...
write.table(alpha1,"Results/Phytoplankton/02.Alpha/01.Estimators/alpha_diversity_indices.txt",
            sep = "\t",row.names = FALSE)
...
pdf("Results/Phytoplankton/01.ASV.tax/Phylogenetic_tree.pdf",width = 8,height = 8)
p
dev.off()
...
#### Boxplot
dir.create("Results/Phytoplankton/02.Alpha/01.Estimators/alpha_div_boxplot")
source("Functions/Diff_alpha.R")
result <- diff.alpha.boxplot(alpha1,group)
for (i in 2:ncol(alpha1)) {
    pdf(file = paste("Results/Phytoplankton/02.Alpha/01.Estimators/alpha_div_boxplot/",
                     colnames(alpha1)[i],".pdf",sep = ""),
        width = 0.8 + 0.8*Group_numb,height = 3.6)
    print(result[[i-1]])
    dev.off()
}
write.table(result[[8]],"Results/Phytoplankton/02.Alpha/01.Estimators/div_test.txt",
            row.names = FALSE,sep = "\t")

#### Jitter
dir.create("Results/Phytoplankton/02.Alpha/01.Estimators/alpha_div_jitter")
source("Functions/Diff_alpha2.R")
result <- diff.alpha.jitter(alpha1,group)
for (i in 2:ncol(alpha1)) {
    pdf(file = paste("Results/Phytoplankton/02.Alpha/01.Estimators/alpha_div_jitter/",
                     colnames(alpha1)[i],".pdf",sep = ""),
        width = 0.8 + 0.8*Group_numb,height = 3.6)
    print(result[[i-1]])
    dev.off()
...
#### violin
dir.create("Results/Phytoplankton/02.Alpha/01.Estimators/alpha_div_violin")
source("Functions/Diff_alpha3.R")
result <- diff.alpha.violin(alpha1,group)
for (i in 2:ncol(alpha1)) {
    pdf(file = paste("Results/Phytoplankton/02.Alpha/01.Estimators/alpha_div_violin/",
                     colnames(alpha1)[i],".pdf",sep = ""),
        width = 0.8 + 0.8*Group_numb,height = 3.6)
    print(result[[i-1]])
    dev.off()
...
#### Rarefaction curve
dir.create("Results/Phytoplankton/02.Alpha/03.Rarefaction")
source("Functions/rare.spec.R")
result <- rare.spec(bac1,group)
pdf("Results/Phytoplankton/02.Alpha/03.Rarefaction/rarefaction.pdf",height = 4,width = 5)
result[[1]]
dev.off()
pdf("Results/Phytoplankton/02.Alpha/03.Rarefaction/speccum.pdf",height = 4,width = 5)
result[[2]]
dev.off()

## Community analysis
dir.create("Results/Phytoplankton/03.Community")
tax.name <- c("Phylum","Genus")

### abundance table
dir.create("Results/Phytoplankton/03.Community/01.tax_summary")
source("Functions/tax.summary.R")
result <- tax.summary(bac3)
for (i in 1:2) {
    write.table(result[[i]],
                paste("Results/Phytoplankton/03.Community/01.tax_summary/",
...
### Abundance chart
dir.create("Results/Phytoplankton/03.Community/02.Abundance_chart")
source("Functions/Community.s.R")
result <- community.s(bac3,group,species.type)
pdf(file = "Results/Phytoplankton/03.Community/02.Abundance_chart/Phylum.pdf",
    width = 0.3*Sample_numb + 1 + max(str_length(bac3$Phylum))*0.12,height = 5)
result
dev.off()
result <- community.s(data.group,group,species.type)
pdf(file = "Results/Phytoplankton/03.Community/02.Abundance_chart/Phylum_Group.pdf",
...
pdf(file = "Results/Phytoplankton/03.Community/02.Abundance_chart/Genus.pdf",
...
pdf(file = "Results/Phytoplankton/03.Community/02.Abundance_chart/Genus_Group.pdf",
...
pdf(file = "Results/Phytoplankton/03.Community/02.Abundance_chart/Genus_heatmap_cluster.pdf",
...
### Venn analysis
dir.create("Results/Phytoplankton/02.Alpha/02.Venn")
#### Venn diagram
if (length(levels(group$Group)) <= 5) {
    ...
    venn.diagram(species,
                 filename = "Results/Phytoplankton/02.Alpha/02.Venn/venn.png",
    ...
    pdf("Results/Phytoplankton/02.Alpha/02.Venn/venn.pdf",
    ...
    write.table(core_species_id_g,
                "Results/Phytoplankton/02.Alpha/02.Venn/Shared_species.txt",
                sep = "\t",row.names = FALSE)
}else{
    source("Functions/Flower.g.R")
    pdf(file = "Results/Phytoplankton/02.Alpha/02.Venn/Venn.pdf",
        width = 8,height = 8)
    flower.g(bac2,group)
    dev.off()
...
pdf(file = "Results/Phytoplankton/02.Alpha/02.Venn/Shared_species_abundance_diff_boxplot.pdf",
    width = wid*Group_numb,height = 4.2)
result[[1]]
dev.off()
pdf(file = "Results/Phytoplankton/02.Alpha/02.Venn/Shared_species_abundance_diff_jitter.pdf",
    width = wid*Group_numb,height = 4.2)
result[[2]]
dev.off()
pdf(file = "Results/Phytoplankton/02.Alpha/02.Venn/Shared_species_abundance_diff_violin.pdf",
    width = wid*Group_numb,height = 4.2)
result[[3]]
dev.off()
sink("Results/Phytoplankton/02.Alpha/02.Venn/Shared_species_abundance_diff_test.txt")
result[[4]]
sink()
...
write.table(tax.number,
            "Results/Phytoplankton/02.Alpha/02.Venn/Shared_species_tax_percentage.txt",
            row.names = FALSE,sep = "\t")
pdf(file = "Results/Phytoplankton/02.Alpha/02.Venn/Shared_species_tax_percentage.pdf",
    width = 10,height = 8)
...
dir.create("Results/Phytoplankton/04.Beta")
dir.create("Results/Phytoplankton/04.Beta/01.beta_diversity")
dir.create("Results/Phytoplankton/04.Beta/02.Distance")
dir.create("Results/Phytoplankton/04.Beta/03.PCA")
dir.create("Results/Phytoplankton/04.Beta/04.PCoA")
dir.create("Results/Phytoplankton/04.Beta/05.NMDS")
dir.create("Results/Phytoplankton/04.Beta/08.Beta_test")

#### PCA 
source("Functions/PCA.R")
result <- pca.community(t(bac2),group,species.type)
write.table(result[[1]],"Results/Phytoplankton/04.Beta/03.PCA/PCA_top2.txt",
            sep = "\t",row.names = FALSE)
pdf(file = "Results/Phytoplankton/04.Beta/03.PCA/PCA_group.pdf",
    width = 7.5,height = 5.4)
result[[2]]
dev.off()
pdf(file = "Results/Phytoplankton/04.Beta/03.PCA/PCA_ellipse.pdf",
    width = 7.5,height = 5.4)
result[[3]]
dev.off()
pdf(file = "Results/Phytoplankton/04.Beta/03.PCA/PCA_label.pdf",
    width = 7.5,height = 5.4)
result[[4]]
dev.off()
write.table(result[[5]],"Results/Phytoplankton/04.Beta/03.PCA/PCA_score.txt",sep = "\t")
...
write.table(as.matrix(result[[1]]),
            "Results/Phytoplankton/04.Beta/01.beta_diversity/Bray_Curtis_distance.txt",
            sep = "\t")
write.table(result[[2]],"Results/Phytoplankton/04.Beta/04.PCoA/PCoA_top2.txt",
            sep = "\t",row.names = FALSE)
pdf(file = "Results/Phytoplankton/04.Beta/04.PCoA/PCoA_group.pdf",
    width = 7.5,height = 5.4)
result[[3]]
dev.off()
pdf(file = "Results/Phytoplankton/04.Beta/04.PCoA/PCoA_ellipse.pdf",
    width = 7.5,height = 5.4)
result[[4]]
dev.off()
pdf(file = "Results/Phytoplankton/04.Beta/04.PCoA/PCoA_label.pdf",
    width = 7.5,height = 5.4)
result[[5]]
dev.off()
write.table(result[[6]],"Results/Phytoplankton/04.Beta/04.PCoA/PCoA_score.txt",sep = "\t")

#### NMDS for Bray_Curtis distance
source("Functions/NMDS.R")
result <- nmds.community(t(bac2),group,species.type)
write.table(result[[1]],"Results/Phytoplankton/04.Beta/05.NMDS/Microbe_stress.txt",
            sep = "\t",row.names = FALSE)
write.table(result[[2]],"Results/Phytoplankton/04.Beta/05.NMDS/NMDS_score.txt",
            sep = "\t",row.names = FALSE)
pdf(file = "Results/Phytoplankton/04.Beta/05.NMDS/NMDS_group.pdf",
    width = 7.5,height = 5.4)
result[[3]]
dev.off()
pdf(file = "Results/Phytoplankton/04.Beta/05.NMDS/NMDS_ellipse.pdf",
    width = 7.5,height = 5.4)
result[[4]]
dev.off()
pdf(file = "Results/Phytoplankton/04.Beta/05.NMDS/NMDS_label.pdf",
    width = 7.5,height = 5.4)
result[[5]]
dev.off()
...
sink("Results/Phytoplankton/04.Beta/08.Beta_test/Adonis.txt")
result[[1]]
sink()
sink("Results/Phytoplankton/04.Beta/08.Beta_test/ANOSIM.txt")
result[[2]]
sink()
sink("Results/Phytoplankton/04.Beta/08.Beta_test/MRPP.txt")
result[[3]]
sink()

#### Distance heatmap for Bray_Curtis distance
dist_dd <- as.matrix(dist_bray)
pdf("Results/Phytoplankton/04.Beta/02.Distance/Distance_heatmap.pdf",
...
pdf(file = "Results/Phytoplankton/04.Beta/02.Distance/Group_distance_diff_boxplot.pdf",
    width = Group_numb*0.5 + 0.5,height = 4.2)
result[[1]]
dev.off()
pdf(file = "Results/Phytoplankton/04.Beta/02.Distance/Group_distance_diff_jitter.pdf",
    width = Group_numb*0.5 + 0.5,height = 4.2)
result[[2]]
dev.off()
pdf(file = "Results/Phytoplankton/04.Beta/02.Distance/Group_distance_diff_violin.pdf",
    width = Group_numb*0.5 + 0.5,height = 4.2)
result[[3]]
dev.off()
sink("Results/Phytoplankton/04.Beta/02.Distance/Group_distance_diff_test.txt")
summary(result[[4]])
sink()

### Different abundance chart
dir.create("Results/Phytoplankton/03.Community/03.Differential")
source("Functions/top30.R")
result <- top30(bac3)
source("Functions/diff.heatmap.R")
Diff_heat <- diff.heatmap(result,group)
pdf("Results/Phytoplankton/03.Community/03.Differential/Phylum_heatmap.pdf",
...
Diff_heat[[1]]
dev.off()
pdf("Results/Phytoplankton/03.Community/03.Differential/Genus_heatmap.pdf",
...
pdf("Results/Phytoplankton/03.Community/03.Differential/Phylum_bubblechart.pdf",
    width = 0.5*Group_numb + 1 + max(str_length(bac3$Phylum))*0.1,
    height = ifelse(length(unique(bac3$Genus)) > 30, 7, 
                    0.22*length(unique(bac3$Genus)) + 1))
Diff_heat[[1]]
dev.off()
pdf("Results/Phytoplankton/03.Community/03.Differential/Genus_bubblechart.pdf",
    width = 0.5*Group_numb + 1 + 
        max(str_length(bac3$Genus[complete.cases(bac3$Genus)]))*0.1,
    height = ifelse(length(unique(bac3$Genus)) > 30, 7, 
                    0.22*length(unique(bac3$Genus)) + 1))
...
dir.create("Results/Phytoplankton/03.Community/04.Indicator")
source("Functions/Indicator.R")
result <- tax.summary(bac3)
Ind.result <- Indicator.indval(result,group)
write.table(Ind.result[[1]],
            "Results/Phytoplankton/03.Community/04.Indicator/Phylum_indicator.txt",
            sep = "\t")
write.table(Ind.result[[2]],
            "Results/Phytoplankton/03.Community/04.Indicator/Genus_indicator.txt",
            sep = "\t")

### SIMPER analysis
dir.create("Results/Phytoplankton/03.Community/05.SIMPER")
...
for (i in 1:length(temp)) {
    write.table(simper.result[[1]][[i]],
                "Results/Phytoplankton/03.Community/05.SIMPER/Phylum_SIMPER.txt",
                sep = "\t")
    write.table(simper.result[[2]][[i]],
                "Results/Phytoplankton/03.Community/05.SIMPER/Genus_SIMPER.txt",
                sep = "\t")
}

### Wilcox test
dir.create("Results/Phytoplankton/03.Community/06.Wilcox")
source("Functions/wilcox.abun.R")
source("Functions/wilcox.plot.R")
source("Functions/wilcox.R")
for (i in 1:length(temp)) {
    dir.create(paste("Results/Phytoplankton/03.Community/06.Wilcox/",temp[i],sep = ""))
    dd <- c()
    ...
    dir.create(paste("Results/Phytoplankton/03.Community/06.Wilcox/",temp[i],"/Phylum",
                     sep = ""))
    set.seed(1111)
    wilcox.result <- wilcox.biomarker(otu,group1)
    write.table(wilcox.result[[1]],
                paste("Results/Phytoplankton/03.Community/06.Wilcox/",temp[i],
    ...
    if (nrow(wilcox.result[[2]]) > 0) {
        ...
        pdf(paste("Results/Phytoplankton/03.Community/06.Wilcox/",temp[i],
    ...
    dir.create(paste("Results/Phytoplankton/03.Community/06.Wilcox/",temp[i],"/Genus",
                     sep = ""))
    set.seed(1111)
    wilcox.result <- wilcox.biomarker(otu,group1)
    write.table(wilcox.result[[1]],
...
if (!is.null(ENV)) {
    ...
    dir.create("Results/Phytoplankton/05.Environment")
    dir.create("Results/Phytoplankton/05.Environment/01.Diff_ENV")
    dir.create("Results/Phytoplankton/05.Environment/02.CCA_RDA")
    dir.create("Results/Phytoplankton/05.Environment/04.Mantel")
    dir.create("Results/Phytoplankton/05.Environment/05.Diversity_heatmap")
    dir.create("Results/Phytoplankton/05.Environment/06.TopAbun_heatmap")
    dir.create("Results/Phytoplankton/05.Environment/03.ABT")
    
    #### CCA/RDA
    source("Functions/CCA(RDA).R")
    result <- cca.rda(t(bac2),ENV,group)
    write.csv(result[[1]], file = "Results/Phytoplankton/05.Environment/02.CCA_RDA/dca.csv")
    write.csv(result[[2]], file = "Results/Phytoplankton/05.Environment/02.CCA_RDA/cca.sample.csv")
    write.csv(result[[3]], file = "Results/Phytoplankton/05.Environment/02.CCA_RDA/cca.env.csv")
    write.csv(result[[4]], file = "Results/Phytoplankton/05.Environment/02.CCA_RDA/cca.species.csv")
    pdf("Results/Phytoplankton/05.Environment/02.CCA_RDA/CCA.pdf",width = 7.5,height = 5.4)
    print(result[[5]])
    dev.off()
    write.csv(result[[6]], file = "Results/Phytoplankton/05.Environment/02.CCA_RDA/ccaenvfit.csv")
    write.csv(result[[7]],file="Results/Phytoplankton/05.Environment/02.CCA_RDA/rda.sample.csv")
    write.csv(result[[8]],file="Results/Phytoplankton/05.Environment/02.CCA_RDA/rda.env.csv")
    write.csv(result[[9]],file="Results/Phytoplankton/05.Environment/02.CCA_RDA/rda.species.csv")
    pdf("Results/Phytoplankton/05.Environment/02.CCA_RDA/RDA.pdf",width = 7.5,height = 5.4)
    print(result[[10]])
    dev.off()
    write.csv(result[[11]],file="Results/Phytoplankton/05.Environment/02.CCA_RDA/rdaenvfit.csv")
    ...
    write.table(result[[1]]$r,
                "Results/Phytoplankton/05.Environment/05.Diversity_heatmap/correlation.xls",
                sep="\t",quote=FALSE,col.names=NA)
    write.table(result[[1]]$p,
                "Results/Phytoplankton/05.Environment/05.Diversity_heatmap/pvalue.xls",
                sep="\t",quote=FALSE,col.names=NA)
    pdf("Results/Phytoplankton/05.Environment/05.Diversity_heatmap/Diversity_heatmap.pdf",
    ...
    write.table(result.abun[[1]]$r,
                "Results/Phytoplankton/05.Environment/06.TopAbun_heatmap/correlation_phylum.xls",
                sep="\t",quote=FALSE,col.names=NA)
    write.table(result.abun[[1]]$p,
                "Results/Phytoplankton/05.Environment/06.TopAbun_heatmap/pvalue_phylum.xls",
                sep="\t",quote=FALSE,col.names=NA)
    pdf("Results/Phytoplankton/05.Environment/06.TopAbun_heatmap/heatmap_phylum.pdf",
    ...
    write.table(result.abun[[1]]$r,
                "Results/Phytoplankton/05.Environment/06.TopAbun_heatmap/correlation_genus.xls",
                sep="\t",quote=FALSE,col.names=NA)
    write.table(result.abun[[1]]$p,
                "Results/Phytoplankton/05.Environment/06.TopAbun_heatmap/pvalue_genus.xls",
                sep="\t",quote=FALSE,col.names=NA)
    pdf("Results/Phytoplankton/05.Environment/06.TopAbun_heatmap/heatmap_genus.pdf",
    ...
    write.table(ABT.result[[1]],
                "Results/Phytoplankton/05.Environment/03.ABT/ABT_result.txt",
                row.names = FALSE,sep = "\t")
    pdf("Results/Phytoplankton/05.Environment/03.ABT/ABT_result.pdf",
    ...
    write.table(result[[1]],
                "Results/Phytoplankton/05.Environment/01.Diff_ENV/ENV_diff_test.txt",
                row.names = FALSE,sep = "\t")
    for (i in 1:ENV_numb) {
        pdf(paste("Results/Phytoplankton/05.Environment/01.Diff_ENV/diff_",
    ...
    pdf("Results/Phytoplankton/05.Environment/04.Mantel/Procrustes.pdf",width = 6,height = 5)
    print(result[[1]])
    dev.off()
    sink("Results/Phytoplankton/05.Environment/04.Mantel/Mantel.txt")
    result[[2]]
    sink()
    sink("Results/Phytoplankton/05.Environment/04.Mantel/Procrustes.txt")
    result[[3]]
    sink()
    
    #### Random forest for sample distinguishing
    dir.create("Results/Phytoplankton/03.Community/07.RandomForest")
    result <- tax.summary(bac3)
    source("Functions/RandomForest_classification.R")
    tax.name <- c("Phylum","Genus")
    for (i in 1:length(tax.name)) {
        dir.create(paste("Results/Phytoplankton/03.Community/07.RandomForest/",
                         tax.name[i],sep = ""))
        set.seed(1111)
        RF.result <- Random.forest.biomarker(result[[i]],group,ENV)
        pdf(paste("Results/Phytoplankton/03.Community/07.RandomForest/",
        ...
        write.table(importance.otu,
                    paste("Results/Phytoplankton/03.Community/07.RandomForest/",
    ...
    dir.create("Results/Phytoplankton/06.Mechanism")
    
    if (!is.null(GEO)) {
        #### Distance-decay similarity of GEO
        dir.create("Results/Phytoplankton/06.Mechanism/01.GEO_regression")
        source("Functions/GEO.regression.R")
        result <- GEO.regression(GEO,bac2,group)
        pdf("Results/Phytoplankton/06.Mechanism/01.GEO_regression/GEO_regression.pdf",
            width = 4.5,height = 3)
        print(result[[1]])
        dev.off()
        write.table(result[[2]],
                    "Results/Phytoplankton/06.Mechanism/01.GEO_regression/GEO_regression.txt",
                    sep = "\t")
        
        #### VPA
        source("Functions/VPA.env.spa.R")
        dir.create("Results/Phytoplankton/06.Mechanism/03.VPA")
        for (i in 1:length(levels(group$Group))) {
            ...
            pdf(file = paste("Results/Phytoplankton/06.Mechanism/03.VPA/vpa_",
                             levels(group$Group)[i],".pdf",sep = ""),
                width = 8,height = 6)
            plot(vpa, bg = 2:3,digits = 2,Xnames = c("ENV","GEO"))
            dev.off()
            sink(paste("Results/Phytoplankton/06.Mechanism/03.VPA/vpa_",
    ...
    source("Functions/VPA.env.spa.hydro.R")
    dir.create("Results/Phytoplankton/06.Mechanism/03.VPA")
    for (i in 1:length(levels(group$Group))) {
      otu <- t(bac2[,group[group$Group == levels(group$Group)[i],"variable"]])
      ENV1 <- ENV[group[group$Group == levels(group$Group)[i],"variable"],]
      ...
      vpa <- vpa.arg2(otu,ENV1,GEO1,hydro1)
      pdf(file = paste("Results/Phytoplankton/06.Mechanism/03.VPA/vpa_hydro_",
                       levels(group$Group)[i],".pdf",sep = ""),
          width = 8,height = 6)
      plot(vpa, bg = 2:3,digits = 2,Xnames = c("ENV","GEO","Hydro"))
      dev.off()
      sink(paste("Results/Phytoplankton/06.Mechanism/03.VPA/vpa_hydro_",
                 levels(group$Group)[i],".txt",sep = ""))
      print(vpa)
      sink()
    }
    ...
    source("Functions/VPA.MRM.env.spa.hydro.R")
    dir.create("Results/Phytoplankton/06.Mechanism/03.VPA")
    for (i in 1:length(levels(group$Group))) {
      otu <- t(bac2[,group[group$Group == levels(group$Group)[i],"variable"]])
      ENV1 <- ENV[group[group$Group == levels(group$Group)[i],"variable"],]
      ...
      vpa <- vpa.mrm.arg3(otu,ENV1,GEO1,hydro1)
      pdf(file = paste("Results/Phytoplankton/06.Mechanism/03.VPA/vpa_mrm_hydro_",
                       levels(group$Group)[i],".pdf",sep = ""),
          width = 8,height = 6)
      plot(vpa, bg = 2:3,digits = 2,Xnames = c("GEO","ENV","Hydro"))
      dev.off()
      sink(paste("Results/Phytoplankton/06.Mechanism/03.VPA/vpa_mrm_hydro_",
                 levels(group$Group)[i],".txt",sep = ""))
      print(vpa)
      sink()
    }
    ...
    dir.create("Results/Phytoplankton/06.Mechanism/04.rdaccahp")
    if (file.exists("Input/vpa_env.txt")) {
      ENV <- read.table("Input/vpa_env.txt",header = TRUE,sep = "\t")
      rownames(ENV) <- ENV[,1]
      ENV <- ENV[,-1]
    ...
    for (i in 1:length(levels(group$Group))) {
      ...
      pdf(file = paste("Results/Phytoplankton/06.Mechanism/04.rdaccahp/RDA_",
                       levels(group$Group)[i],".pdf",sep = ""),
          width = 8,height = 6)
    ...
    dir.create("Results/Phytoplankton/06.Mechanism/02.ENV_regression")
    source("Functions/ENV.regression.R")
    result <- ENV.regression(ENV,bac2,group)
    pdf("Results/Phytoplankton/06.Mechanism/02.ENV_regression/ENV_regression.pdf",
        width = 4.5,height = 3)
    print(result[[1]])
    dev.off()
    write.table(result[[2]],
                "Results/Phytoplankton/06.Mechanism/02.ENV_regression/ENV_regression.txt",
                sep = "\t")
    
    
    ### Ecological quality prediction
    dir.create("Results/Phytoplankton/07.EcoPredict")
    
    ### Prediction environmental factors via microbial communities
    dir.create("Results/Phytoplankton/07.EcoPredict/03.SingleENV")
    source("Functions/RandomForest_regression.R")
    result <- tax.summary(bac3)
    for (i in 1:length(levels(group$Group))) {
        dir.create(paste("Results/Phytoplankton/07.EcoPredict/03.SingleENV/",
        ...
        for (j in 1:ENV_numb) {
            ...
            pdf(paste("Results/Phytoplankton/07.EcoPredict/03.SingleENV/",
            ...
            importance.otu <- importance.otu[,c("ID",colnames(importance.otu)[1:(ncol(importance.otu)-1)])]
            write.table(importance.otu,
                        paste("Results/Phytoplankton/07.EcoPredict/03.SingleENV/",
    ...
    dir.create("Results/Phytoplankton/07.EcoPredict/01.TotalENV")
    ...
    pdf("Results/Phytoplankton/07.EcoPredict/01.TotalENV/Prediction.pdf",
    ...
    importance.otu <- importance.otu[,c("ID",colnames(importance.otu)[1:(ncol(importance.otu)-1)])]
    write.table(importance.otu,
                "Results/Phytoplankton/07.EcoPredict/01.TotalENV/importance.txt",
                sep = "\t",row.names = FALSE)
    pdf("Results/Phytoplankton/07.EcoPredict/01.TotalENV/RandomForest_biomarker.pdf",
        height = nrow(importance.otu)*0.3 + 1.85,width = 9)
    print(RF.result[[3]])
    dev.off()
    write.table(RF.result[[4]],
                "Results/Phytoplankton/07.EcoPredict/01.TotalENV/biomarker_abundance.txt",
                sep = "\t") 
    write.table(RF.result[[5]],
                "Results/Phytoplankton/07.EcoPredict/01.TotalENV/Predicted_value.txt",
                sep = "\t") 
    write.table(RF.result[[6]],
                "Results/Phytoplankton/07.EcoPredict/01.TotalENV/Predicted_accuracy.txt",
                sep = "\t") 
    
    
    ### Prediction of environmental groups by microbial communities
    dir.create("Results/Phytoplankton/07.EcoPredict/02.ENVGroup")
    ### Prediction of environmental groups by microbial communities
    ...
    if (!is.null(ENV.part) > 0) {
        for (j in 1:nrow(ENV.part)) {
            dir.create(paste("Results/Phytoplankton/07.EcoPredict/02.ENVGroup/",
            ...
            RF.result <- Random.forest.regression2(result[[2]],group11,
                                                   ...
                                                   group)
            pdf(paste("Results/Phytoplankton/07.EcoPredict/02.ENVGroup/",
            ...
            importance.otu <- importance.otu[,c("ID",colnames(importance.otu)[1:(ncol(importance.otu)-1)])]
            write.table(importance.otu,
                        paste("Results/Phytoplankton/07.EcoPredict/02.ENVGroup/",
